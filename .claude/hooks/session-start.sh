...
# provision.sh installs mise and OpenCode into npm's global prefix, which is on
# PATH for the shell that runs this hook but not necessarily for the session's.
